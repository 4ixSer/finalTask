...
public class Request {
     ...
     */
    private Car characteristicsСar;
    ...
    public Car getCharacteristicsСak() {
        return characteristicsСar;
    }

    public void setCharacteristicsСar(Car characteristicsСar) {
        this.characteristicsСar = characteristicsСar;
    }
    ...
    public Request(User ownerRequest, LocalDateTime dataRequest, LocalDateTime dataDeparture, Car characteristicsСak,
            Status status, String note) {
        super();
        this.ownerRequest = ownerRequest;
        this.dataRequest = dataRequest;
        this.dataDeparture = dataDeparture;
        this.characteristicsСar = characteristicsСak;
        this.status = status;
        this.note = note;
    }
    ...
    public String toString() {
        return "Request [namberRequest=" + namberRequest + ", ownerRequest=" + ownerRequest + ", dataRequest="
                + dataRequest + ", dataDeparture=" + dataDeparture + ", characteristicsСak=" + characteristicsСar
